...
//   return (
//     <section className="relative  overflow-hidden bg-gradient-to-br from-green-500 via-blue-50/50 to-green-50/50 pt-8 pb-16 md:pt-16 md:pb-24 bg-[--background]">
...
//             <span className="font-semibold text-[#C77DFF]"> 100+ Products Inside Every Pack</span>
//           </motion.p>
...
//               <Button 
//                 size="lg" 
//                 className="w-full sm:w-auto bg-gradient-to-r from-[#9D4EDD] to-[#C77DFF] hover:from-[#C77DFF] hover:to-[#9D4EDD] text-white font-bold text-lg px-8 py-6 shadow-xl shadow-purple-200 hover:shadow-purple-300 transition-all hover:scale-105"
//               >
//                 Shop All Bundles
...
//   return (
//     <section className="relative overflow-hidden bg-gradient-to-br from-white via-blue-50/50 to-green-50/50 pt-8 pb-24 md:pt-16 md:pb-32">
