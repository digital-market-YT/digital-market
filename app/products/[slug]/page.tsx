        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="inline-block bg-gradient-to-r from-yellow-500 to-yellow-600 px-8 py-6 rounded-full mb-8">
            <h2 className="text-3xl md:text-4xl font-bold text-black">
              100+ AI Baby Fruit Eating Fruits Reels
            </h2>
          </div>
          ...
          <p className="text-gray-400 text-lg max-w-3xl mx-auto mb-10">
            Skip hours of editing. Get 100+ high-engagement AI Baby Fruits Eating
            Fruits Viral Reels, ready to post on Instagram, YouTube Shorts, and TikTok.
      ...
      <section className="py-20 px-4 bg-black/30">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-20">
            {[
              {
                title: '100+AI Baby Fruit Eating Fruits reels',
        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <div className="bg-gradient-to-br from-green-900/50 to-green-800/50 rounded-2xl p-8 border-2 border-green-500">
              ...
              <div className="text-6xl font-bold text-green-400 mb-6">₹99</div>
      ...
      <section className="py-20 px-4 bg-black/30">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-4">
              Before vs After Using 100+ Ready-to-Post Reels
            </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
            ...
            <div className="bg-gradient-to-br from-green-900/30 to-green-800/30 rounded-2xl p-8 border-2 border-green-600 relative">
              ...
              <h3 className="text-2xl font-bold mb-6">After Using 100+ Ready-to-Post Reels</h3>
              <div className="space-y-4">
                {[
